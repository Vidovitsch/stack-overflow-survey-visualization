function donutChart() {
    var data = [],
        ...
        colour = d3.scaleOrdinal(["#D0CDFD", "#7B74FC", "#3D33FB"]), // colour scheme
    ...
    function chart(selection){
        selection.each(function() {
            ...
            var path = svg.select('.slices')
              ...
              .enter().append('path')
                .attr('fill', function(d) {
                  ...
                  console.log(colour(d.data[category]))
            ...
            function updateLabelText(d) {
                return d.data[category] + ': <tspan>' + Math.round(d.data[variable] * 10) / 10 + 'h</tspan>';
            }
